    ...
    <div className="min-h-screen canvas-bg text-navy">
      <section className="hero-painted relative py-24 px-6 overflow-hidden">
        <div className="max-w-4xl mx-auto relative text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="font-display text-5xl md:text-7xl font-black mt-6 text-white drop-shadow-lg">UNE3Q</h1>
            <p className="text-xl text-white/50 leading-relaxed max-w-2xl mx-auto mt-6">A creative studio dedicated to crafting unique, handmade pieces that celebrate individuality and self-expression.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="text-center mt-12">
          <Link to="/custom" className="inline-flex items-center gap-2 btn-painted-purple px-8 py-4 rounded-full font-black transition-all">
