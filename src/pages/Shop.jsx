    ...
    <div className="min-h-screen canvas-bg text-navy">
      <section className="hero-painted relative py-20 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto relative text-center">
          ...
          <h1 className="font-display text-5xl md:text-7xl font-black text-white mt-4 drop-shadow-lg">The Collection</h1>
        </div>
      </section>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button onClick={() => addItem({ id: product.id, name: product.name, price: Number(product.price), image: img })}
                          className="btn-painted-purple rounded-full px-4 py-2 font-bold text-sm transition-all">
                          Add to Cart
                        </button>
                      </div>
                    </div>
