            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                <input
                  ...
                  className="rounded-full px-5 py-3 bg-white/10 border border-white/20 text-white placeholder:text-white/30 focus:border-purple focus:outline-none transition text-sm"
                  required
                />
                <button type="submit" className="bg-purple text-white rounded-full px-5 py-3 font-bold flex items-center justify-center gap-2 hover:scale-[1.02] transition-all text-sm">
